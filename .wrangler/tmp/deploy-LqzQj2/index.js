...
// worker/index.js
var API = "https://solopulse-api.paekfeel-solopulse.workers.dev";
var index_default = {
  async fetch(request, env) {
    ...
    if (url.pathname.startsWith("/api/") || url.pathname.startsWith("/auth/") || url.pathname.startsWith("/ws") || url.pathname.startsWith("/bridge")) {
